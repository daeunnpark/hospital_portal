        ...
        if(self.lineEdit_6.text() != self.lineEdit_7.text()):
            ...
            if(cur.rowcount != 0):
                ...
                if(cur.rowcount != 0):
                    ...
                    cur.execute('INSERT INTO Person(ID, FirstName, LastName, PhoneNumber, EmailAddress, Username, UserPassword) VALUES (%s, %s, %s, %s, %s, %s, %s)', ("305",self.lineEdit_1.text(), self.lineEdit_2.text(), self.lineEdit_3.text(), self.lineEdit_4.text(), self.lineEdit_5.text(), self.lineEdit_6.text()))
